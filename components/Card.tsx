  ...
  return (
    <div className="group relative bg-sci-frame p-1 pb-2 rounded-sm shadow-xl hover:shadow-glow transition-shadow duration-300">
      <Link to={`/${type}s/${id}`} className="flex flex-col h-full">
        ...
        <div className="relative bg-sci-screen border-4 border-sci-panel rounded-lg mb-2 overflow-hidden shadow-crt-inset aspect-square w-full flex flex-col items-center justify-center transition-all">
